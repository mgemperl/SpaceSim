...
*/
	...
	Fleet* playerFleet = new Fleet(PLAYERFACTION, testSystem);
	
	m_pPlayer = new Player(m_pInput, playerFleet);
	...
	playerVessel->InstallWeapon(turret, 0);
	//playerVessel->InstallWeapon(guided, 1);
	playerVessel->InstallWeapon(turret, 1);
